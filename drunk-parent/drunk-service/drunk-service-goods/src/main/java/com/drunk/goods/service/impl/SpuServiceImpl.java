...
import com.drunk.goods.dao.CategoryMapper;
import com.drunk.goods.dao.SkuMapper;
import com.drunk.goods.dao.SpuMapper;
import com.drunk.goods.pojo.*;
import com.drunk.goods.service.SpuService;
...
public class SpuServiceImpl implements SpuService {
    ...
    public int putMany(Long[] ids) {
        ...
        criteria.andEqualTo("is_marketable",0);
    ...
    public void saveGoods(Goods goods) {
        ...
        for(Sku sku:goods.getSkuList()){
            ...
            Map<String,String> specitems = JSON.parseObject(specs,Map.class);
            Set<Map.Entry<String, String>> entries = specitems.entrySet();
            //循环组装Sku的名字
