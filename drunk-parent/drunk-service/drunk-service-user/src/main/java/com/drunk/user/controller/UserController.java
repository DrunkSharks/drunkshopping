package com.drunk.user.controller;

import com.alibaba.fastjson.JSON;
import com.drunk.entity.BCrypt;
import com.drunk.entity.JwtUtils;
import com.drunk.user.pojo.User;
import com.drunk.user.service.UserService;
...
public class UserController {
    ...
    public Result login(String username, String password, HttpServletResponse response){
        ...
        if(user!=null && BCrypt.checkpw(password,user.getPassword())){
            ...
            String jwt = JwtUtils.createJwt(UUID.randomUUID().toString(), JSON.toJSONString(subject), null);
        ...
        return new Result(true,StatusCode.LOGINERROR,"账号或密码错误");
    }
